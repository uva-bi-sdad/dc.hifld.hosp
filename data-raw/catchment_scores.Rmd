...
plot_2sfca <- map %>%
  addControl("Hospitals Per 1,000 People (2-Step Floating Catchment Area)", "topright") %>%
...
plot_e2sfca <- map %>%
  addControl("Hospitals Per 1,000 People (enhanced 2-Step Floating Catchment Area)", "topright") %>%
...
plot_3sfca <- map %>%
  addControl("Hospitals Per 1,000 People (3-Step Floating Catchment Area)", "topright") %>%
...
write.csv(dmv_bg_2021_acccess_scores_hospitals, "dmv_bg_2021_acccess_scores_hospitals", row.names = FALSE )
...
sf::st_write(
  dmv_bg_2021_acccess_scores_hospitals, con,
  c("dc_health_behavior_diet", "dmv_cttrbg_hifld_2021_acccess_scores_hospitals"),
