...
dataset:
  citation:
      title: "Social Data Commons: Health, Behavior, Diet: Hospitals Access Scores"
      subtitle: ""
      dsDescriptionValue: "Access Scores for hospitals located in the National Capital Region NCR given by the Floating Catchment Areas "
      subject: "Social Sciences (Ex: Education, Politics, Sociology, Economics, Psychology)"
      productionDate: "2022-02-20"
  ...
  geospatial:
    geographicCoverage:
      ...
      state: "Virginia, Maryland, Washington DC"
    geographicUnit:
      - "County"
      - "Census tract"
      - "Block group"
